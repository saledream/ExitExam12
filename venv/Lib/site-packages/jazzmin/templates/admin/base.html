                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            {% if request.user.avtar %}
                                <img src="{{request.user.avtar.url }}" width="160px" class="img-circle elevation-2" alt="User Image">
                            {% else %}
                            ...
                            {% if jazzmin_settings.navigation_expanded %}
                                {% for app in side_menu_list %}
                                    ...
                                    {% for model in app.models %}
                                      {% if app.name == 'Accounts' and model.name == 'Users' and request.user.user_type == 'instructor' %}
                                      {% else %} 
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a href="{{ model.url }}" class="nav-link">
                                                     ...
                                                     <i {% if app.name == 'Accounts' and model.name == 'Users' %} class="fa fa-users" {% else %} class="nav-icon {{ model.icon }}" {% endif %}> </i> 
                                                    <p>{{ model.name }}</p>
                            ...
                            {% for message in messages %}
                                {% if message.tags == 'success' %}
                                    <div class="alert alert-success alert-dismissible">
                                        ...
                                        <i class="icon fa fa-check"></i>{{ message|safe }}
                                    </div>
                                {% elif message.tags == 'error' %}
                                    <div class="alert alert-danger alert-dismissible">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                                        </button>
                                        <i class="icon fa fa-ban"></i>{{ message|safe|capfirst }}
                                    </div>
                                {% elif message.tags == 'warning' %}
                                    <div class="alert alert-warning alert-dismissible">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                                        </button>
                                        <i class="icon fa fa-exclamation-triangle"></i>{{ message|safe|capfirst }}
                                    </div>
    ...
    {% if not is_popup %}
        <footer class="main-footer {{ jazzmin_ui.footer_classes }}">
            <div class="float-right d-none d-sm-inline">
                <b>{% trans 'EEPP version' %}</b> 1.0 
            </div>
        
            {% autoescape off %}
                <strong>Group 2 &copy; {% now 'Y' %} {{ jazzmin_settings.copyright }}.</strong> {% trans 'All rights reserved.' %}
            {% endautoescape %}
        </footer>
        {% if jazzmin_settings.show_ui_builder %}
